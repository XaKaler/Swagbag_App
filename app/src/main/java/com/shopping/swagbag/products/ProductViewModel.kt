...
class ProductViewModel(
    ...
    fun brandDetails(brandName: String): LiveData<Resource<BrandDetailsModel>> {

        val brand = MutableLiveData<Resource<BrandDetailsModel>>()

        viewModelScope.launch {
            brand.value = Resource.Loading
            brand.value = repository.brandDetails(brandName)
        }
