...
class UserViewModel(private val repository: UserRepository) : ViewModel() {
    ...
    fun login(
        ...
        viewModelScope.launch {
            ...
            signInResponse.value = repository.login(email, password)
        }
    ...
    fun loginWithGoogle(
        ...
        viewModelScope.launch {
            signInResponse.value = Resource.Loading
            signInResponse.value = repository.loginWithGoogle(token, email)
        }
        return signInResponse
    }
    ...
    fun loginWithFacebook(
        ...
        viewModelScope.launch {
            signInResponse.value = Resource.Loading
            signInResponse.value = repository.loginWithFacebook(token, email)
        }
        return signInResponse
    }
    ...
    fun registerFacebook(
        ...
        viewModelScope.launch {
            signUpResponse.value = Resource.Loading
            signUpResponse.value = repository.registerFacebook(token, email, fName, lName)
        }
        return signUpResponse
    }
