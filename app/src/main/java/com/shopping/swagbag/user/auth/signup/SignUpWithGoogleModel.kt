...
data class SignUpWithGoogleModel(
    val message: String, // Login was successfull
    val result: Result,
    ...
    data class Result(
        ...
        val createdDate: String, // 2022-07-14T07:07:18.363Z
        ...
        val doc3Type: String,
        val email: String, // akkikaler91@gmail.com
        ...
        val fullName: String,
        @SerializedName("_id")
        val id: String, // 62cfefad0c02fa4020e077c2
        val ifsc: Any?, // null
        val lname: String,
        ...
        val slug: String,
        val sso: String, // google
        val subscription: Subscription,
        @SerializedName("update_date")
        val updateDate: String, // 2022-07-14T07:07:18.363Z
