...
class HomeTopTrendingAdapter(
    private val context: Context,
    private val data: List<HomeModel.Result.Section.Banner>,
    private val itemClick: RecycleViewItemClick
) :
    RecyclerView.Adapter<HomeTopTrendingAdapter.MyViewHolder>() {

    inner class MyViewHolder(private val viewBinding: SingleTopTrendingBinding) :
        RecyclerView.ViewHolder(viewBinding.root) {

        fun bind(singleData: HomeModel.Result.Section.Banner,position: Int, itemClick: RecycleViewItemClick){
            with(viewBinding){
                // set image
